...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Termos e Condições — Aluguer de Bicicletas e Equipamentos | FeelAzores Sports" },
      {
        name: "description",
        content:
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="px-6 pt-20 pb-12 text-center">
        ...
        <h1 className="mx-auto max-w-4xl font-display text-4xl leading-[1.05] text-primary md:text-5xl uppercase">
      ...
      <section id="pt" className="px-6 pb-20">
        <div className="mx-auto mb-12 max-w-3xl text-center">
          ...
          <h2 className="mt-2 font-display text-2xl text-primary md:text-3xl uppercase">
            Termos e Condições — Aluguer de Bicicletas e Equipamentos
          </h2>
        </div>
